 ...
 * {@linkplain Handler#getFilter() body} filter)
 *
 ...
 * (default is {@linkplain Formatter#toString() toString}
 ...
 * {@linkplain Comparator} class used to sort the published
 ...
 * {@linkplain Charset#name() character set} to use for the
 ...
 * and {@linkplain Object#hashCode() hashCode} methods.
 ...
 * with a {@linkplain MemoryHandler} typically with an
 ...
 * {@linkplain ByteArrayOutputStream#toString(String) string}
 ...
 * Session, InputStream) reconstruct}, and resend the
